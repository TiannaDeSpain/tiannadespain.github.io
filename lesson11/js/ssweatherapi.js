...
const apiURL = "http://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=64286fe075e1c1e85b00043631a855cb&units=imperial";
fetch(apiURL)
...
const apiURL2 = "http://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=64286fe075e1c1e85b00043631a855cb&units=imperial";
fetch(apiURL2)
  .then((response) => response.json())
  .then((jsObject) => {
    console.log(jsObject);
